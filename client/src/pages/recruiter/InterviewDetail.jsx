...
const InterviewDetail = () => {
      ...
      try {
        ...
        setTimeout(() => {
          setInterview({
            ...
            status: 'scheduled',
            notes: 'Initial screening interview to assess technical skills and cultural fit.',
  ...
  const handleStatusChange = async (newStatus) => {
    // TODO: Update interview status via API
          ...
          <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 font-medium text-gray-900 dark:text-white">{interview.interviewer}</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="mt-1 font-medium text-gray-900 dark:text-white">{interview.candidate.name}</p>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-gray-400" />
                <span className="text-gray-700 dark:text-gray-300">{interview.candidate.email}</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="h-4 w-4 text-gray-400" />
                <span className="text-gray-700 dark:text-gray-300">{interview.candidate.phone}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-md border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-2">
              {interview.status === 'scheduled' && (
                <>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 rounded-md bg-red-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-red-700"
                  >
              ...
              <button
                onClick={() => navigate(`/dashboard/recruiter/messages?candidateId=${interview.candidate.id}`)}
              ...
              <button
                onClick={() => navigate(`/dashboard/recruiter/candidates/${interview.candidate.id}`)}
