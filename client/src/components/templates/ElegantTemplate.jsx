            ...
            <header className="mb-8 text-center border-b-2 pb-6" style={{ borderBottomColor: accentColor }}>
              <div className="mb-4">
                {getProfileImageSrc(data.personal_info?.image) ? (
                  <img
                    ...
                    alt="Profile"
                    className="w-32 h-32 rounded-full object-cover mx-auto border-4 mb-4"
                    style={{ borderColor: accentColor }}
                  />
                ) : (
                  <div
                    className="w-32 h-32 rounded-full mx-auto border-4 mb-4 bg-gray-100 flex items-center justify-center"
                    style={{ borderColor: accentColor }}
                  >
              ...
              <h1
                className={`${getNameFontSize(
                  sectionFontSizes
                )} font-bold mb-3 text-gray-900 tracking-wide`}
              >
              ...
              {data.personal_info?.profession && (
                <p
                  className={`${getSectionFontSize(
                    sectionFontSizes,
                    "title"
                  )} font-medium mb-6 text-gray-600 italic`}
                >
                  {data.personal_info.profession}
                </p>
              )}
              ...
              <div className="text-center mb-4">
                <h2
                  className={`${getSectionHeaderFontSize(
                    sectionFontSizes
                  )} font-bold text-gray-900 mb-2 tracking-widest uppercase`}
                >
                  Professional Summary
                </h2>
                <div className="w-24 h-0.5 mx-auto" style={{ backgroundColor: accentColor }}></div>
              </div>
              <p
                className={`text-gray-700 leading-relaxed text-center italic ${getSectionFontSize(
                  sectionFontSizes,
                  "summary"
                )}`}
              >
              ...
              <div className="space-y-6">
                {data.experience.map((exp, index) => (
                  <div key={index} className="relative pl-8">
                    ...
                    ></div>
                    <div className="border-l-2 pl-6" style={{ borderLeftColor: accentColor }}>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {projectsToRender.map((proj, index) => (
                  ...
                  >
                    ...
                    {proj.technologies && (
                      <p
                        className="text-xs font-semibold mb-2 italic"
                        style={{ color: accentColor }}
                      >
                        {proj.technologies}
                      </p>
                    ...
                    {proj.link && (
                      <p
                        className="text-xs break-all mt-2 italic"
                        style={{ color: accentColor }}
                      >
            ...
            {showEducation && data.education && data.education.length > 0 && (
              <section className="mb-8">
                <div className="text-center mb-6">
                  ...
                  <div className="w-16 h-0.5 mx-auto" style={{ backgroundColor: accentColor }}></div>
                </div>
