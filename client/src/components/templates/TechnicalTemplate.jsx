        ...
        <div className="flex-1">
          ...
          {showHeader && (
            <header className="mb-5 relative">
              ...
              <div className="pt-4 pb-4 border-b" style={{ borderBottomColor: accentColor + '30' }}>
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                      ...
                      <div>
                        <h1
                          className={`${getNameFontSize(
                            sectionFontSizes
                          )} font-bold mb-0.5 text-gray-900 tracking-tight`}
                        >
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1.5 text-xs mt-2">
                  ...
                  <div className="flex-shrink-0">
                    {getProfileImageSrc(data.personal_info?.image) ? (
                      ...
                      <div
                        className="w-20 h-20 rounded border-2 bg-gray-100 flex items-center justify-center"
                        style={{ borderColor: accentColor }}
                      >
