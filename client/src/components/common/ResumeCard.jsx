...
const ResumeCard = ({ name, lastUpdated, onEdit, onDelete }) => (
  <div className="group relative flex h-full min-h-[200px] flex-col rounded-md border border-gray-200 bg-white p-5 shadow-sm transition-all duration-300 hover:border-[var(--primary-color)] hover:bg-gray-50 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800 dark:hover:border-[var(--primary-color)] dark:hover:bg-gray-800/90">
    ...
    <div className="absolute right-3 top-3 z-10 flex items-center gap-1.5 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
      ...
      <button
        ...
        className="flex h-8 w-8 items-center justify-center rounded-md bg-white text-red-600 shadow-md transition-all hover:scale-110 hover:shadow-lg dark:bg-gray-700 dark:text-red-400"
