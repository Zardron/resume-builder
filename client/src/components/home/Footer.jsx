...
const Footer = () => {
  return (
    <footer className="w-full bg-slate-50 text-slate-700 mt-20">
      <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col items-center">
        <div className="flex items-center space-x-3 mb-6">
          <a href="https://prebuiltui.com" className="flex items-center gap-1">
            <img
              src={LOGO}
              alt="logo"
              className="w-8 h-8 border border-slate-200 rounded-md bg-white"
            />{" "}
        ...
        <p className="text-center max-w-xl text-sm font-normal leading-relaxed text-slate-600">
          Build standout resumes effortlessly with AI-powered tools. Create
          polished, professional resumes in minutes and land your dream job.
        </p>

        <div className="flex items-center space-x-6 mt-6">
          <a href="/" className="text-slate-600 hover:text-rose-500 transition" title="Facebook">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
            </svg>
          </a>
          <a href="/" className="text-slate-600 hover:text-rose-500 transition" title="Instagram">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="/" className="text-slate-600 hover:text-rose-500 transition" title="LinkedIn">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="/" className="text-slate-600 hover:text-rose-500 transition" title="Github">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-6 text-center text-sm font-normal text-slate-600">
