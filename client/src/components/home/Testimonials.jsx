...
const Testimonials = () => {
  const cardsData = [
    {
      ...
      handle: "@neilstellar",
      date: "April 20, 2025",
      testimonial: "Got my dream job within 2 weeks! This resume builder made my application stand out from the crowd."
    },
    {
      image:
      ...
      handle: "@averywrites",
      date: "May 10, 2025",
      testimonial: "The AI suggestions are incredible. It helped me highlight skills I didn't even know how to present."
    },
    {
      image:
      ...
      handle: "@jordantalks",
      date: "June 5, 2025",
      testimonial: "Finally, a resume tool that doesn't require hours of tweaking. Beautiful templates and instant formatting."
    },
    {
      image:
      ...
      handle: "@averywrites",
      date: "May 10, 2025",
      testimonial: "Switched 3 different templates and exported to PDF in minutes. Highly recommend!"
    },
  ];

  const CreateCard = ({ card }) => (
    <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 bg-white dark:bg-slate-800 text-gray-900 dark:text-slate-100">
  ...
  return (
    ...
    >
      ...
      <div className="marquee-row w-full mx-auto max-w-6xl overflow-hidden relative px-4">
