          ...
          <div className="bg-white dark:bg-gray-900 rounded-md max-w-2xl w-full max-h-[80vh] overflow-hidden border border-gray-200 dark:border-gray-700 shadow-xl">
            ...
            >
              <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
                ...
                <p>
                  By accessing and using this AI-powered ResumeIQHub service, you accept
                ...
                <p>
                  Our ResumeIQHub is an AI-powered platform that helps users create professional, 
                ...
                <p>
                  Permission is granted to use this ResumeIQHub for personal and professional 
